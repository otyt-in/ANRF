export const stories = [
  {
    title: "Planting Hope, One Rosewood at a Time",
    slug: "planting-hope-one-rosewood-at-a-time",
    category: "Field update",
    excerpt: "ANRF has planted more than 2,000 East Indian Rosewood saplings on its farmland near Mundgod.",
  },
  {
    title: "Why East Indian Rosewood Needs Documentation",
    slug: "why-east-indian-rosewood-needs-documentation",
    category: "Documentation",
    excerpt: "The long-term goal is to document forest regeneration methods that can support broader conservation work.",
  },
  {
    title: "Naya Nari: Where Nature Inspires, Women Design",
    slug: "naya-nari-where-nature-inspires-women-design",
    category: "Social support",
    excerpt: "Naya Nari helps women around Sanavalli build craft skills, confidence and alternative income pathways.",
  },
];
